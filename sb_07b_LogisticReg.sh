...
#SBATCH  --job-name=cSCC102b_GP_Z_v02d_cluster
#SBATCH --output=rq_cSCC102b_GP_Z_v02d_cluster_%A_%a.out
#SBATCH  --error=rq_cSCC102b_GP_Z_v02d_cluster_%A_%a.err
...
python3 ./report_representationsleiden_tight.py \
--meta_folder cSCC102_v02a_tight_GP_ff1 \
